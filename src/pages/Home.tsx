...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-8 pb-4 lg:pt-10 lg:pb-6 flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center w-full">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/80 backdrop-blur-sm border border-indigo-100 shadow-sm mb-3 animate-fade-in-up mt-2">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-3 tracking-tight leading-tight">
            Discover <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">Unique</span> Fashion & Style
          </h1>

          <p className="text-base md:text-lg text-gray-600 mb-4 max-w-2xl mx-auto leading-relaxed font-light">
            The world's first AI-powered marketplace. Buy, sell, and discover exclusive drops from top brands and your community.
          </p>

          <div className="w-full max-w-4xl mx-auto mb-4 transform hover:scale-[1.01] transition-transform duration-300">
            <HeroSearch />
          </div>
          ...
          {!isAuthenticated && (
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-4">
              <Link
                to="/signup"
                className="px-6 py-2.5 rounded-full bg-gray-900 text-white font-semibold text-sm hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 flex items-center"
              >
                Start Exploring
